...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_ENDPOINTS_GET = {"/api/users/verify-email", "/api/admin/getGenres", "/api/movie/**", "/api/user/movie", "/api/user/movie/suggest", "/api/user/movie/comment/**", "/api/user/movie/rating/**", "/api/paypal/success"};
